...
public class Cover extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        add(title);
        description = new JLabel("Para mantenerse conectada con nosotras por favor");
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(37, 133, 157 ), 0, getHeight(), new Color(119, 124, 13 ));
        g2.setPaint(gra);
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                description1.setText("y ayuda en la busqueda de mascotas perdidas");
